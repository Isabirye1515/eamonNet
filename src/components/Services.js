...
import { ServiceDesk } from '@carbon/icons-react';
...
export default function Services() {
  ...
  return (
    <>
    <Grid className='p-5'  >
                                                          <Column lg={16} md={8} sm={4}  className="d-flex text-lighter " >
                                  <ServiceDesk size={30} /> <h2  >Services</h2>
                                  </Column> 
           {services.map((service)=>(

              <Column lg={8} sm={4} md={4} key={service.id} className='m-0 mt-5 p-1  rounded  text-center' >
